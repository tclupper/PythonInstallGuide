...
1) [Notepad++ (ver 8.7.5)](NotepadPlusPlus.md) (This is the text editor that I use)
...
4) [VScode (ver 1.96.3)](VScode.md)  (This is the development IDE that I use)
...
* Vector graphics viewing, creating and editing
    ...
    * [DrawIO Desktop (ver 26.0.4)](https://github.com/jgraph/drawio-desktop/releases)
...
* EE specific tools
    ...
    * [LTspice (ver 24.1.0)](https://www.analog.com/en/design-center/design-tools-and-calculators/ltspice-simulator.html) ~Circuit simulation
    ...
    * [Chirp-next (ver 20250110)](https://chirp.danplanet.com/projects/chirp/wiki/Download) ~HAM radio programming software
...
* Utilities
    * [Free 42 (ver 3.1.12)](https://thomasokken.com/free42/) ~HP42S calculator app
