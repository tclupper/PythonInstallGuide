...
1) [Notepad++ (ver 8.9.3)](NotepadPlusPlus.md) (This is the text editor that I use)
...
3) [Miniforge3 (ver 26.1.1-3)](Miniforge.md)  (Stripped down version of Anaconda)
4) [VScode (ver 1.115.0)](VScode.md)  (This is the development IDE that I use)
...
* For Visual Basic and C# applications, I use [Visual Studio Community 2022 (ver 17.14.29)](https://visualstudio.microsoft.com/vs/community)

* Office suite

    * [Libre Office (ver 26.2.2)](https://www.libreoffice.org)
* Latex document editor
    * [Texworks/MikTex (ver 0.6.10/ver 25.12)](https://miktex.org/download)
* Reference material manager
    * [Zotero (ver 8.0.4)](https://www.zotero.org/download/)
...
* Vector graphics viewing, creating and editing
    ...
    * [DrawIO Desktop (ver 29.6.6)](https://github.com/jgraph/drawio-desktop/releases)
* 2D mechanical drawing
    * [LibreCAD (ver 2.2.1.4)](https://github.com/LibreCAD/LibreCAD/releases)
* 3D mechanical drawing and modeling
    * [OpenSCAD (ver 2026.04.08)](https://openscad.org/downloads.html)
    * [FreeCAD (ver 1.1.0)](https://www.freecad.org)
* 3D printing utilities
    * [PrusaSlicer (ver 2.9.4)](https://www.prusa3d.com/prusaslicer)
    * [MeshLab (ver 2025.07)](https://www.meshlab.net/#download)
* EE specific tools
    * [KiCAD (ver 10.0.0)](https://kicad.org/download/windows/) ~Schematic capture and PCB layout
    ...
    * [Chirp-next (ver 20260403)](https://chirp.danplanet.com/projects/chirp/wiki/Download) ~HAM radio programming software
